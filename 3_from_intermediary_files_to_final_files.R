...
# Users can either load one of the files included in the intermediary directory
# ("sp500_tau_0.025_gen_files.RData" or "shanghai_comp_tau_0.025_gen_files"), or use any intermediary file
# generated by the script '2_from_raw_files_to_intermediary_files.R' for the nine indices
