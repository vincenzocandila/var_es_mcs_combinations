...
# Users can either load one of the example files included in the intermediary directory
# (sp500_tau_0.025_files or shanghai_comp_tau_0.025_files), or use any intermediary file
