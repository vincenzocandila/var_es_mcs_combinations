...
- code/2_from_intermediary_files_to_final_files. 	: R script to compute the six proposed forecast combinations and the four benchmark methods from the intermediary datasets;
- code/3_replicate_figure_2_and_tables_5_to_7.R 	: R script to reproduce Figure 2 and Tables 5–7 using the pre-computed result files included in data/results/ or the files obtained from '2_from_intermediary_files_to_final_files.R';
