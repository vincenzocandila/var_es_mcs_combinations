...
##########################################
#### Load data for plots (specifically, those included in Figure 2)
##########################################

# The user can either load
# "data/results/shanghai_comp_tau_0.025_final_results.RData"
# or reproduce it by running the script
# "3_from_intermediary_files_to_final_files.R"

load("data/results/shanghai_comp_tau_0.025_final_results.RData")

#############################################################################
#### shanghai_comp_tau_0.025_final_results includes:
...
# The user can either load
# "data/results/sp500_tau_0.025_final_results.RData"
# or reproduce it by running the script
# "3_from_intermediary_files_to_final_files.R"

load("data/results/sp500_tau_0.025_final_results.RData")

#############################################################################
#### sp500_tau_0.025_final_results includes:
## r_t_oos_full_plot				: daily log-returns for the training plots;
## r_t_oos_full					: daily log-returns for the out-of-sample period;
## nstep							: total number of model re-estimations (i.e., length of the out-of-sample period);
## lab_full						: model labels, including 32 models, 4 benchmarks (EW-Comb, Median-Comb, RS-Comb, MS-Comb),
...
######################################################################
# Table 7 can be directly replicated using the pre-aggregated result files included:
