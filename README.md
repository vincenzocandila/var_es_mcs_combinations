...
|:---------------|:----------------------------|:--------------------|
| `replicate_tables_and_figures.R` | Standard laptop (Intel i5-1135G7 @ 2.4 GHz, 16 GB RAM) | ~1–2 minutes |
| `generate_proposed_combinations.R` | Standard laptop (Intel i5-1135G7 @ 2.4 GHz, 16 GB RAM) | ~3–4 minutes|
